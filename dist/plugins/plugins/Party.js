...
class Party extends _Plugin.default {
  ...
  getTeamScores(args, user) {
    user.send('get_team_scores', {
      blue: this.handler.partyData.blueTotal,
      red: this.handler.partyData.redTotal,
      blueLeaderboard: this.handler.partyData.blueLeaderboard,
      redLeaderboard: this.handler.partyData.redLeaderboard
    });
  }

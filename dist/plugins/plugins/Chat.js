...
class Chat extends _Plugin.default {
  ...
  sendMessage(args, user) {
    ...
    (async () => {
      ...
      var wordWhitelist = ['shoes', 'afk', 'coco', 'engage', 'echoes', 'snowshoes', 'horseshoes', 'shoestrings', 'offkey', 'saltwater', 'wristwatch', 'outfit', 'longer', 'so thoughtful', 'halloween', 'mermaid', 'restful', 'therapeutic', 'ginger', 'singer', 'grape', 'noodle', 'vague', 'floral', 'skills', 'rubbish', 'california', 'nugget'];
